...
-- ******************** SqlDBM: Microsoft SQL Server ********************
	-- ***** Generated by SqlDBM: HomNayAnGi, v1 by dv.chien@outlook.com ****
	-- ************************************** [UserAccount]
	...
	[Mobile]     varchar(10) NOT NULL ,
	[Email]      varchar(30) NOT NULL ,
	[AvatarPath] varchar(max) NOT NULL ,
	...
	[CategoryImagePath] varchar(max) NOT NULL ,
	...
	[FoodImagePath] varchar(max) NOT NULL ,


	CONSTRAINT [PK_Food] PRIMARY KEY CLUSTERED ([food_id] ASC),
	CONSTRAINT [FK_Cate_Food] FOREIGN KEY ([category_id])  REFERENCES [FoodCategory]([category_id])
	);
	GO
	...
	CONSTRAINT [PK_Fav_Food] PRIMARY KEY CLUSTERED ([fav_id] ASC),
	CONSTRAINT [FK_Acc_Fav] FOREIGN KEY ([account_id])  REFERENCES [UserAccount]([account_id]),
	CONSTRAINT [FK_Food_Fav] FOREIGN KEY ([food_id])  REFERENCES [Food]([food_id])
	);
	GO


	CREATE NONCLUSTERED INDEX [FK_Acc_Fav_Index] ON [FavoriteFood] 
	(
	[account_id] ASC
	)
	...
	CREATE NONCLUSTERED INDEX [FK_Food_Fav_Index] ON [FavoriteFood] 
	(
	[food_id] ASC
	)
